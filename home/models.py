...
class Settings(models.Model):
    ...
    facebook = models.URLField(max_length=150,default="facebook")
    instagram = models.URLField(max_length=150,default="instagram")
    twitter = models.URLField(max_length=150,default="twitter")
    linkedin = models.URLField(max_length=150,default="linkedin")
